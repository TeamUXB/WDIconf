...
# Oauth for multiple social network platform
gem 'omniauth'
...
group :development, :test do
  ...
  # helpers guide for leveraging regular Ruby classes and object oriented design patterns to build a simple, robust & scaleable authorization system.
  gem "pundit"
